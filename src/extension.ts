...
export function activate(context: vscode.ExtensionContext) {
	...
	let tests200  = vscode.commands.registerCommand('jackal-plugin.t200', () => {
		vscode.window.showInformationMessage('We will now generate Test of HTTP:200 for this collection Jackal Plugin!');
	});
